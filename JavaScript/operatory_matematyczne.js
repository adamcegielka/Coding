...
// pozostałe operatory rwykonują działanie
...
console.log("number = " + number); // wynik 25
...
number++;
console.log("number = " + number); // wynik 2
...
var newValue = ++number;
console.log("newValue = " + newValue); // wynik 2

// odejmowanie wartości o jeden -> predekrementacja - wykonuje sie przed
var newValue = --number;
console.log("newValue = " + newValue); // wynik 1
